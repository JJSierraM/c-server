...
To use it, execute the server with

$ ./out/server 

and then as many clients as you want with 

$ ./out/client address port

By default, the server is linked to 127.0.0.1:34197, to use it in local network as an example, but it can be configured to use any available port. Remember to open your port in your router or firewall if you want to do so!
